...
def create_tpu_node(node_id, network, subnetwork, network_range, tpu_type, preemptible):
...
def tpu_submit_state(
    ...
    **kwargs,
    ...
    cmd = (
        ...
        f"pip install -e polytax; "
        f"python3 polytax/src/polytax/train.py"
    )
